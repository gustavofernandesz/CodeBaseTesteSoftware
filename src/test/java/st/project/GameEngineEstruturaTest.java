...
class GameEngineEstruturaTest {
    ...
    @Test
    @DisplayName("Estrutura: sala na borda norte (y=0) não deve ter vizinho norte")
    ...
    @Test
    @DisplayName("Estrutura: sala na borda oeste (x=0) não deve ter vizinho oeste")
    ...
    @Test
    @DisplayName("Estrutura: sala na borda leste (x=4) não deve ter vizinho leste")
    ...
    @Test
    @DisplayName("Estrutura: timer deve parar após tempo zerar")
    ...
    @Test
    @DisplayName("Estrutura: timer deve parar ao encerrar jogo por movimentos")
    ...
    @Test
    @DisplayName("Estrutura: timer deve parar ao encerrar jogo por vitória")
    ...
    @Test
    @DisplayName("Fronteira: isChaveAtiva retorna false quando inventário está vazio")
    void testeFronteiraIsChaveAtivaInventarioVazio() {
        assertFalse(engine.isChaveAtiva());
    }

    @Test
    @DisplayName("Fronteira: isChaveAtiva retorna false com outros itens mas sem chave")
    ...
    @Test
    @DisplayName("Fronteira: isChaveAtiva retorna true após adicionar chave")
